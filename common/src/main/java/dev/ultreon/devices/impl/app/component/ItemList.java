...
public class ItemList<E> extends Component implements Iterable<E> {
    ...
    protected dev.ultreon.devices.impl.app.component.Button btnUp;
    protected dev.ultreon.devices.impl.app.component.Button btnDown;
    ...
    public void init(Layout layout) {
        btnUp = new dev.ultreon.devices.impl.app.component.Button(left + width - 12, top, Icons.CHEVRON_UP);
