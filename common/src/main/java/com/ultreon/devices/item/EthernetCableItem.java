...
public class EthernetCableItem extends Item {
    ...
    @Override
    public void appendHoverText(ItemStack stack, @org.jetbrains.annotations.Nullable World level, @NotNull List<Component> tooltip, @NotNull TooltipFlag isAdvanced) {
        if (stack.hasTag()) {
