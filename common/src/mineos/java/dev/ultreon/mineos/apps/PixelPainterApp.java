package dev.ultreon.mineos.apps;
...
import dev.ultreon.mineos.apps.system.layout.StandardLayout;
import dev.ultreon.mineos.userspace.MineOS;
import dev.ultreon.devices.core.io.FileSystem;
import dev.ultreon.devices.debug.DebugLog;
import dev.ultreon.mineos.object.Canvas;
import dev.ultreon.mineos.object.ColorGrid;
import dev.ultreon.mineos.object.Picture;
...
public class PixelPainterApp extends Application {
    ...
    private dev.ultreon.mineos.object.Canvas canvas;
    ...
    public void init(@Nullable CompoundTag intent) {
        ...
        canvas = new dev.ultreon.mineos.object.Canvas(5, 5);
        ...
        btnPencil.setClickListener((mouseX, mouseY, mouseButton) -> canvas.setCurrentTool(dev.ultreon.mineos.object.Canvas.PENCIL));
        ...
        btnBucket.setClickListener((mouseX, mouseY, mouseButton) -> canvas.setCurrentTool(dev.ultreon.mineos.object.Canvas.BUCKET));
        ...
        btnEraser.setClickListener((mouseX, mouseY, mouseButton) -> canvas.setCurrentTool(dev.ultreon.mineos.object.Canvas.ERASER));
