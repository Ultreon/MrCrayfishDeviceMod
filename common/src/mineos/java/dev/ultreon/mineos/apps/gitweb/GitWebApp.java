package dev.ultreon.mineos.apps.gitweb;
...
import dev.ultreon.mineos.apps.gitweb.layout.TextLayout;
...
public class GitWebApp extends Application implements SystemAccessor, DataHandler {
    ...
    public void init(@Nullable CompoundTag intent) {
        ...
        layoutBrowser.setBackground((graphics, mc, x, y, width, height, mouseX, mouseY, windowActive) -> {
            Color color = new Color(MineOS.get().getSettings().getColorScheme().getItemBackgroundColor());
