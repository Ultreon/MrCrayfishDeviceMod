...
public class AppInfo {
    ...
    private transient final ApplicationID APP_ID;
    ...
    private static final TintProvider DEFAULT_TINT_PROVIDER = new TintProvider() {
        ...
        public int getTintColor(AppInfo info, int o) {
            return switch (o) {
                case 1 -> MineOS.get().getSettings().getColorScheme().getBackgroundColor();
                case 2 -> MineOS.get().getSettings().getColorScheme().getBackgroundSecondaryColor();
    ...
    public static class Icon {
        ...
        private Icon(AppInfo info) {
            this.base = Glyph.of(new ResourceLocation(info.APP_ID.namespace(), "textures/app/icon/base/" + info.APP_ID.getPath() + ".png"));
            this.base.type = 0;
            this.overlay0 = Glyph.of(new ResourceLocation(info.APP_ID.namespace(), "textures/app/icon/overlay0/" + info.APP_ID.getPath() + ".png"));
            this.overlay0.type = 1;
            this.overlay1 = Glyph.of(new ResourceLocation(info.APP_ID.namespace(), "textures/app/icon/overlay1/" + info.APP_ID.getPath() + ".png"));
    ...
    public void reload() {
        ...
        Resource resource = Minecraft.getInstance().getResourceManager().getResource(new ResourceLocation(APP_ID.namespace(), "/apps/" + APP_ID.getPath() + ".json")).orElse(null);
    ...
    public static class Deserializer implements JsonDeserializer<AppInfo> {
        ...
        private void deserializeSchemaVersion0(JsonElement json, JsonDeserializationContext context) throws JsonParseException {
            ...
            if (json.getAsJsonObject().has("icon") && json.getAsJsonObject().get("icon").isJsonPrimitive()) {
                ...
                info.icon.overlay0 = Icon.Glyph.of(new ResourceLocation(info.APP_ID.namespace(), "textures/app/icon/overlay0/empty.png"));
                info.icon.overlay0.type = 1;
                info.icon.overlay1 = Icon.Glyph.of(new ResourceLocation(info.APP_ID.namespace(), "textures/app/icon/overlay1/empty.png"));
