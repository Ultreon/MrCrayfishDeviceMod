 ...
 * @author MrCrayfish
 */
public final class PrinterRenderer extends TileEntityRenderer<PrinterBlockEntity> {
    public PrinterRenderer(TileEntityRendererDispatcher p_i226006_1_) {
        super(p_i226006_1_);
    }

    @Override
    public void render(@NotNull PrinterBlockEntity blockEntity, float partialTick, @NotNull MatrixStack pose, @NotNull IRenderTypeBuffer bufferSource, int packedLight, int packedOverlay) {
...
//            this.main = pRoot.getChild("main");
        ...
        @Override
        public void renderToBuffer(@NotNull MatrixStack p_225598_1_, @NotNull IVertexBuilder p_225598_2_, int p_225598_3_, int p_225598_4_, float p_225598_5_, float p_225598_6_, float p_225598_7_, float p_225598_8_) {
