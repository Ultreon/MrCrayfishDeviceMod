...
public class PrinterBlock extends DeviceBlock.Colored implements Colored {
    ...
    public ActionResultType use(@NotNull BlockState state, World level, @NotNull BlockPos pos, @NotNull PlayerEntity player, @NotNull Hand hand, @NotNull BlockRayTraceResult hit) {
