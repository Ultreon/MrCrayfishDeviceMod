...
public abstract class Component extends AbstractGui {
     ...
     * @param windowActive if the window is active (at front)
     */
    protected void renderOverlay(MatrixStack pose, Laptop laptop, Minecraft mc, int mouseX, int mouseY, boolean windowActive) {
    }
    ...
    public void drawVerticalLine(MatrixStack pose, int x, int y1, int y2, int rgb) {
        fill(pose, x, y1, x + 1, y2, rgb);
    }

    public void drawHorizontalLine(MatrixStack pose, int x1, int x2, int y, int rgb) {
