...
import dev.ultreon.devices.impl.app.ScrollableLayout;
import dev.ultreon.devices.impl.app.component.Button;
import dev.ultreon.devices.impl.app.component.Image;
import dev.ultreon.devices.impl.app.renderer.ItemRenderer;
...
import dev.ultreon.mineos.apps.system.component.Palette;
import dev.ultreon.mineos.apps.system.object.ColorScheme;
import dev.ultreon.mineos.apps.system.object.ColorSchemePresetRegistry;
import dev.ultreon.mineos.apps.system.object.Preset;
...
public class SettingsApp extends SystemApp {
    ...
    private void resetColorSchemeClick(int mouseX, int mouseY, int mouseButton) {
        if (mouseButton == 0) {
            MineOS.get().getSettings().getColorScheme().resetDefault();
        }
    }
...
/*                    """*/, Reference.getVerInfo()[0], Reference.getVerInfo()[1]));
    ...
    private Layout createColorSchemesLayout() {
        ...
        list.setItemClickListener((preset, index, button) -> {
            ...
            MineOS.get().getSettings().setPreset(preset);
        });
    ...
    private Layout createColorSchemeLayout() {
        ...
        comboBoxTextColor.setValue(MineOS.get().getSettings().getColorScheme().getTextColor());
        ...
        comboBoxTextSecondaryColor.setValue(MineOS.get().getSettings().getColorScheme().getTextSecondaryColor());
        ...
        comboBoxHeaderColor.setValue(MineOS.get().getSettings().getColorScheme().getHeaderColor());
        ...
        comboBoxBackgroundColor.setValue(MineOS.get().getSettings().getColorScheme().getBackgroundColor());
        ...
        comboBoxBackgroundSecondaryColor.setValue(MineOS.get().getSettings().getColorScheme().getBackgroundSecondaryColor());
        ...
        comboBoxItemBackgroundColor.setValue(MineOS.get().getSettings().getColorScheme().getItemBackgroundColor());
        ...
        comboBoxItemHighlightColor.setValue(MineOS.get().getSettings().getColorScheme().getItemHighlightColor());
    ...
    public static class SettingsTrayItem extends TrayItem {
        ...
        public void handleClick(int mouseX, int mouseY, int mouseButton) {
            ...
            if (info != null) {
                MineOS.get().openApplication(info);
            }
        }
    }
}
